"""
Tests automatiques pour la configuration et la structure du dossier trans_sent.
Ce module vérifie :
- La validité de la config (clés, types, valeurs)
- L'existence des dossiers/fichiers principaux
- Le bon chargement des utilitaires
"""
import unittest
import os
